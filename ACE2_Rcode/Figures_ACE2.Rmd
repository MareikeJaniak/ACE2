...
```{r}
mammal_tree <- read.tree("/Users/Mareike/Documents/Data/ACE2/Mammalia_species.nwk")
```

Drop tips that are not in species list: (necessary because TimeTree species list upload not working at the time)
```{r}
species_list <- read.delim("/Users/Mareike/Documents/Data/ACE2/species_list_ACE2.txt", header = FALSE)
...
```{r}
risk_df <- read.delim("/Users/Mareike/Documents/Data/ACE2/covid-risk.tsv", header = TRUE, sep = "\t")
...
```{r}
p_msa <- msaplot(p_tr2, "/Users/Mareike/Documents/Data/ACE2/ACE2_MSA_for_figure.fasta", offset = 33, width = 0.9)
p_msa
...
library(Biostrings)
library (ggmsa)
x <- readAAStringSet("/Users/Mareike/Documents/Data/ACE2/ACE2_MSA_for_figure.fasta")
...
* Read in trees:
```{r}
MrBayes_tree <- read.tree("/Users/Mareike/Documents/Data/ACE2/GeneTrees/ACE2_MrBayes_tree.newick")
RAxML_tree <- read.tree("/Users/Mareike/Documents/Data/ACE2/GeneTrees/ACE2_RAxML_tree.newick")
```
